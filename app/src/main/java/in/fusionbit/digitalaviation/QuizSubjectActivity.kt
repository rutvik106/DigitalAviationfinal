...
class QuizSubjectActivity : AppCompatActivity(), SubjectAdapter.SubjectClick {
                    ...
                    if (errorObject.getString("error_code") == "0") {
                        ...
                        binding.rvQuizSubject.apply {
                            ...
                            binding.rvQuizSubject.layoutManager =
                                LinearLayoutManager(this@QuizSubjectActivity)
                            binding.rvQuizSubject.adapter =
                                SubjectAdapter(this@QuizSubjectActivity,subjectList, this@QuizSubjectActivity)
                        }
                        progressDialog.cancel()
